...
function Footer() {
  return (
    <div className=" w-full flex gap-5 h-screen bg-zinc-900 px-20 py-40 font-['Founders_Grotesk_Regular'] ">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="headings">
          <h1 className="text-[6vw] font-semibold leading-none -mb-4">EYE-</h1>
          <h1 className="text-[6vw] font-semibold leading-none -mb-4">
            OPENING
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] font-semibold leading-none">PRESENTATIONS</h1>
        <div className="dets font-['Neue_Montreal'] mt-15">
          <a className="block text-xl font-light py-3 " href="#">
            Instagram
          </a>
          <a className="block text-xl font-light py-3 " href="#">
            Behance
